...
@pytest.mark.parametrize('cmd_line, expected_parsed_line', [
...
def test_remove_comments_and_spaces_from_line_and_return(cmd_line, expected_parsed_line):
    assert Parser._remove_comments_and_spaces_from_line_and_return(cmd_line) == expected_parsed_line


@pytest.mark.parametrize('input_line, expected_cmd', [
